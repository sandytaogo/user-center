...
/**
 * 声明auth2.0 授权配置 Spring 这个应用是 OAuth2 的授权服务器,
 * 提供/oauth/authorize,/oauth/token,/oauth/check_token,/oauth/confirm_access,/oauth/error
 *
 * @author Sandy
 * @since 1.0.0 16th 07 2025
 * @see {@code FrameworkEndpointHandlerMapping ,AuthorizationEndpoint, TokenEndpoint,WhitelabelApprovalEndpoint, CheckTokenEndpoint }
 */
@Configuration
@EnableAuthorizationServer
public class Authorization2ServerConfig extends AuthorizationServerConfigurerAdapter {
